...
Bookmark.create(comment: "Recommended by John",
                movie_id: 3,
                list_id: 2)
Bookmark.create(comment: "Superhero movie revisited in 2020",
                movie_id: 1,
                list_id: 3)
Bookmark.create(comment: "Spielberg's masterly Oscar-winning drama",
                movie_id: 2,
                list_id: 2)
Bookmark.create(comment: "2020 release",
                movie_id: 5,
                list_id: 1)
